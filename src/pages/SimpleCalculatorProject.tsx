...
#### JumpQuest Page SEO:
<dyad-write path="src/pages/JumpQuestProject.tsx" description="Add SEO tags to the JumpQuest Unity game page">
import React from "react";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Separator } from "@/components/ui/separator";
import { Badge } from "@/components/ui/badge";
...
const JumpQuestProject: React.FC = () => {
  ...
  return (
    <div className="container mx-auto py-12 px-4">
      <SEO 
        title="JumpQuest: The Curse of Gold Begins Unity Game | Ernie Joseph Cledera"
        description="JumpQuest is a 2D side-scrolling pixel art platformer game designed in Unity. Learn about its physics, graphic assets, and mechanics."
        keywords="JumpQuest game, Unity platformer game, 2D pixel art game development, C# script game design"
        ogImage={project.image}
      />
      <div className="mb-8">
        <Button variant="outline" asChild>
