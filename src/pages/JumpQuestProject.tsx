...
const JumpQuestProject: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title={`${project.title} - Ernie Joseph Cledera`}
        description={project.description}
        url="https://ernie-cledera.github.io/projects/jumpquest"
        keywords={`${project.title}, ${project.technologies.join(', ')}, Ernie Cledera, Unity, C#, Game Development, Pixel Art`}
      />
