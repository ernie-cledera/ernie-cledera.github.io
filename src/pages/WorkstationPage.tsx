...
const WorkstationPage: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="My Workstation - Ernie Joseph Cledera"
        description="Explore my personal workstation setup including hardware specifications, peripherals, displays, and software tools I use for my work."
        url="https://ernie-cledera.github.io/workstation"
        keywords="Workstation, Setup, Hardware, PC Build, Peripherals, Software Tools, Ernie Cledera"
      />
